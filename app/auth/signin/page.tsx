      ...
      <div className="w-full max-w-md">
            ...
            <div className="space-y-2">
              {[
                ...
                <button
                  ...
                  className="w-full text-left p-2.5 bg-white dark:bg-slate-900 rounded-xl border border-primary-100 hover:border-primary-300 transition text-sm flex items-center justify-between group"
                >
                  <div>
                    <span className="font-medium text-slate-900 dark:text-slate-100">{d.email}</span>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl p-6 sm:p-8 shadow-soft dark:shadow-slate-900/50">
          ...
          <button
            ...
            className="w-full py-2.5 border border-slate-200 dark:border-slate-600 rounded-xl text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition flex items-center justify-center gap-2"
          >
